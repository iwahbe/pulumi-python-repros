...
class BytesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[float] length: The number of bytes requested. The minimum value for length is 1.
...
class _BytesState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] hex: The generated bytes presented in lowercase hexadecimal string format. The length of the encoded string is exactly twice
...
class Bytes(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            hex: Optional[pulumi.Input[str]] = None,
            keepers: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
            length: Optional[pulumi.Input[float]] = None) -> 'Bytes':
        """
