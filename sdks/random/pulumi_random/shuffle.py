...
class ShuffleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] keepers: Arbitrary map of values that, when changed, will trigger recreation of resource. See the main provider documentation for
               more information.
        :param pulumi.Input[float] result_count: The number of results to return. Defaults to the number of items in the `input` list. If fewer items are requested, some
    ...
    def result_count(self) -> Optional[pulumi.Input[float]]:
        """
    ...
    @result_count.setter
    def result_count(self, value: Optional[pulumi.Input[float]]):
...
class Shuffle(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            result_count: Optional[pulumi.Input[float]] = None,
            results: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
            seed: Optional[pulumi.Input[str]] = None) -> 'Shuffle':
        """
